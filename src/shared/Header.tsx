...
const Header = () => {
    ...
    return (
        <header className="w-full flex items-center justify-between p-4 shadow-md">
            <div className="logo cursor-pointer" onClick={() => router.push(basicRoutes.home)}>
                <p>Careplus</p>
            </div>
            ...
            <div className='flex items-center gap-x-4'>
                ...
                <div className="sideNavigation hidden md:flex items-center gap-x-2">
                    ...
                    <Button icon={
                        <LoginIcon className='' />
                    } onClick={() => router.push(authenticationRoutes.login)} title='Login' className='rounded-2xl px-5 font-semibold text-sm' />
